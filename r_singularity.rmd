...
I believe the idiosyncracies of most HPC technologies represent the major road
...
widely successful in HPC settings, depsite significant effort. Shifter
...
doMPI, and foreach packages in R.

The program requires the following inputs and assumptions:
